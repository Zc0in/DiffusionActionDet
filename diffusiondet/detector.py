...
'''the new encoder here'''
from .tf_encoder.meta_archs import PtTransformer
from .tf_encoder.models import make_meta_arch
from .tf_encoder.config import DEFAULTS
...
class DiffusionDet(nn.Module):
    ...
    def __init__(self, cfg):
        ...
        # Build Backbone.
        # self.backbone = PtTransformer(cfg)
        self.backbone = make_meta_arch(DEFAULTS['model_name'], DEFAULTS['model'])
